  ...
  return (
    <div>
      ...
      <div style={{ 
        ...
        <Title level={1} style={{ color: 'white' }}>Welcome to Melodies</Title>
      ...
      {/* Popular Artists */}
      <Title level={2} style={{ marginTop: '40px' }}>Popular Artists</Title>
      <Row gutter={[24, 24]}>
        {[1, 2, 3, 4].map(artist => (
          <Col xs={24} sm={12} md={6} key={artist}>
            <Card
              hoverable
              cover={<img alt={`Artist ${artist}`} src="https://via.placeholder.com/200" />}
            >
              <Card.Meta
                title={`Artist ${artist}`}
