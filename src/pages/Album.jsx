        ...
        >
            <Layout
                style={{
                    minHeight: '100vh',
                    background:
                        'linear-gradient(135deg, #1a1221 0%, #2D1F31 100%)',
                }}
            >
                <Header
                    style={{
                ...
                <Content style={{ padding: '0 20px' }}>
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Trending songs{' '}
                                <span style={{ color: '#ff1f9c' }}>mix</span>
                            </Title>
                            <Text
                                style={{
                    ...
                    >
                        ...
                        >
                            ...
                            <Col span={1}>Time</Col>{' '}
                            {/* Điều chỉnh lại số span để khớp */}
                        </Row>
