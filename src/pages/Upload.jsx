  ...
  const audioUploadProps = {
    beforeUpload: (file) => {
      if (!file.type.startsWith("audio/")) {
        message.error("Chỉ hỗ trợ file âm thanh (MP3, WAV, FLAC, v.v.)!");
  ...
  if (!isArtist) {
    return (
      ...
      >
        ...
        >
          <Title level={2} style={{ color: "#ff1f9c", marginBottom: 16 }}>
          ...
          <Button
            ...
            style={{ background: "#ff1f9c", borderColor: "#ff1f9c" }}
          >
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        padding: "24px",
        background: "linear-gradient(to bottom right, #1a1221, #2D1F31)",
      }}
    >
      <Card
        style={{
      ...
      >
        <Title
          level={2}
          style={{ color: "#ff1f9c", textAlign: "center", marginBottom: 32 }}
        >
          Tải Lên Bài Hát
        </Title>
        ...
        <Form form={form} onFinish={handleSubmit} layout="vertical">
          {/* Chọn file nhạc */}
          <Form.Item
            label={<span style={{ color: "#fff" }}>Chọn file nhạc *</span>}
          >
          ...
          <Form.Item
            name="title"
            label={<span style={{ color: "#fff" }}>Tiêu đề bài hát *</span>}
            rules={[{ required: true, message: "Vui lòng nhập tiêu đề!" }]}
          >
            <Input
              placeholder="Nhập tiêu đề bài hát"
              style={{ background: "rgba(91,73,89,0.7)", color: "#fff", border: "none" }}
            />
          </Form.Item>
          ...
          <Form.Item
            name="genre"
            label={<span style={{ color: "#fff" }}>Thể loại nhạc *</span>}
          ...
          {/* Upload ảnh bìa */}
          <Form.Item
            label={<span style={{ color: "#fff" }}>Ảnh bìa (JPG, PNG) *</span>}
          >
          ...
          <Form.Item
            name="lyrics"
            label={<span style={{ color: "#fff" }}>Lời bài hát (nếu có)</span>}
          >
            <TextArea
              rows={4}
          ...
          >
            <Space>
              ...
              <span style={{ color: "#fff" }}>
                {isPublic ? (
                  <>
                    <Globe size={16} style={{ display: "inline", marginRight: 4 }} /> Công khai
                  </>
                ) : (
                  <>
                    <Lock size={16} style={{ display: "inline", marginRight: 4 }} /> Riêng tư
                  </>
                )}
              </span>
            </Space>
          ...
          <Form.Item>
            <Button
              ...
              style={{
                background: "linear-gradient(to right, #ff1f9c, #ff4db2)",
                border: "none",
                borderRadius: 999,
              }}
            >
